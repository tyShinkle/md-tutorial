...
<table>
 <tr>
  <td>&#10071;</td>
  <td>Some Markdown markings are required to be the first characters on the lines which they appear. For example, trying to have an inline heading such as... <code>text # header text</code> would not work</td>
 </tr>
</table>
